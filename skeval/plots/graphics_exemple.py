...
plot_eval(
    run_confidence_eval,
    eval_name="Confidence Threshold Evaluator",
    file_name="confidence_eval",
)
plot_eval(
    run_regression_eval, eval_name="Regression Evaluator", file_name="regression_eval"
)
plot_eval(
    run_regression_noise_eval,
    eval_name="Regression Noise Evaluator",
    file_name="regression_noise_eval",
)
plot_eval(
    run_agreement_eval, eval_name="Agreement Evaluator", file_name="agreement_eval"
)
